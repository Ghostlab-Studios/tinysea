...
<section class="unity-section">
    ...
    <div class="download-builds">
        ...
        <p>For long simulation runs, download the desktop version — no browser needed.</p>
        <div class="download-buttons">
            <a href="/builds/TinySea-Windows.zip" class="download-btn windows">
            ...
            <a href="/builds/TinySea-macOS.zip" class="download-btn macos">
